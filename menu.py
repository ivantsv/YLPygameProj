...
BG = pygame.image.load("../../OneDrive/Рабочий стол/PROJECT/assets/Background.jpeg")
BG = pygame.transform.scale(BG, (1400, 700))



def get_font(size):
    return pygame.font.Font("../../OneDrive/Рабочий стол/PROJECT/assets/font.ttf", size)
...
def main_menu():
    while True:
        ...
        play_button = Button(image=pygame.image.load("../../OneDrive/Рабочий стол/PROJECT/assets/Play Rect.png"), pos=(700, 200),
                             text_input="PLAY", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        quit_button = Button(image=pygame.image.load("../../OneDrive/Рабочий стол/PROJECT/assets/Quit Rect.png"), pos=(700, 500),
